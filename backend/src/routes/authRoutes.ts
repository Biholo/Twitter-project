...
export function authRoutes() {
  ...
  router.get("/me", isAuthenticated, getUserFromToken);
  ...
  router.post("/logout", validateZod(logoutSchema, "body"), logout);
  ...
  router.post("/confirm-email", validateZod(tokenSchema, "body"), confirmEmail);
